...
if [ ! -f "$FITTED/scoring.json" ]; then
  "$PY" -u scripts/calibration_score_states.py \
    --run "$FITTED" --ids "$STREAM" --top-k 1023 --n 25793085 \
