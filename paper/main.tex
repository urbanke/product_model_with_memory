...
pairwise continuous-update potential (Sec.~\ref{sec:pairwise})
                                         & $\mathbf{1.7248}$ & pending & pending \\
\midrule
...
The first validated run is shown in Table~\ref{tab:pairwise-potential}.  Its
exact honest first-order reference is $1.76456248$ bpc.  The stratified
...
\caption{Estimated continuous-update potential of the calibrated pairwise
  ...
  code.  The honest total also includes the exact $0.000164$ bpc nested-state
  subset charge; its analytic 95\% interval is
  $[1.720299,1.729383]$ bpc.  This is an intrinsic continuously refreshed
  potential, not yet the codelength of a particular chunked implementation.}
