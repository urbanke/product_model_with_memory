...
from using all three pairwise margins; its entries are bits per BPE token
over the fitted suffix.  The lower panel gives the complete honest-code
accounting.  Its first four numeric columns are bits per BPE token over the
whole stream; the last is bits per original text8 character.}
...
\midrule
1024 & 5.173282 & 5.061883 & 0.111399 \\
4096 & 7.094082 & 6.923955 & 0.170127 \\
8192 & 8.077821 & 7.879932 & 0.197889 \\
\bottomrule
\end{tabular}
\vspace{0.8em}
...
\toprule
$V$ & reduced prediction & vocabulary & escape payload & total & bits/character \\
\midrule
1024 & 5.062028 & 0.319949 & 4.716307 & 10.098284 & 1.962025 \\
4096 & 6.928956 & 0.320795 & 2.330236 &  9.579986 & 1.861324 \\
8192 & 7.891411 & 0.321631 & 1.205158 &  9.418200 & 1.829890 \\
\bottomrule
\end{tabular}
\end{table}
...
effect dominates.  The honest total falls from $1.962025$ to $1.861324$ and
...
two-pair star rule increases from $0.111399$ to $0.197889$ bits per BPE token.
...
At $V=1024$, reusable checkpoint construction took $871$ seconds with 12
processes and calibration took $151.3$ seconds in the final validation run.
A direct two-pass C builder eliminated the
...
certificate exactly, while reducing measured peak RSS from $10.25$ to
