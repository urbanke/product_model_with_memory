...
alphabets.  \emph{Phase 2} (built and verified; first full run in
progress): the sequential pooled-lag evaluator --- per-step
predictive distributions of the layered per-state mixtures,
refreshed at checkpoints, pooled under both combination rules with
grids averaged at sequence level; its output is the marginal value
of the long-range tail.
