...
estimated pairwise continuous-update potential (Sec.~\ref{sec:pairwise})
                                         & $\mathbf{1.7216}$ & $\mathbf{1.9833}$ & pending \\
\midrule
...
The five validated runs completed so far are shown in
...
additional state-subset charges.  The three \texttt{enwik9} configurations
are still in progress and are therefore not included here.
...
\caption{Estimated continuous-update potential of the calibrated pairwise
  ...
  row and $0.000328$ bpc for the last row.  The intervals propagate only the
