...
sharply reduces the escaped-token payload; over these three runs the latter
effect dominates.  The honest total falls from $1.961478$ to $1.861324$ and
then $1.829890$ bits per original character.  Independently, the upper panel
shows that the third pair remains useful throughout: its gain over the
two-pair star rule increases from $0.022189$ to $0.038189$ bits per original
character.
...
the working alphabet continues to improve the honest code and remains
