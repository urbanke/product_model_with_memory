...
pairwise constraint model (Sec.~\ref{sec:pairwise}) & pending & pending & pending \\
\midrule
...
are in progress; no numerical result is reported until its source manifest,
baseline and original-byte denominator agree.
